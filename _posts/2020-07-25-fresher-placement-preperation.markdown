...
3. How to prepare for the written round ?<br/>
	...
	<b>Preparation:</b> [Leetcode](https://leetcode.com/problemset/all/) and [interviewbit](https://www.interviewbit.com/courses/programming/) are the best resources for preparation if you are applying for an SDE role. <b>They have an abundance of questions with good test cases and tutorials. </b>Important suggestions: 
	<ul>
	...
	If you are appearing for a consultant profile, you can follow [IndiaBix](https://www.indiabix.com/).

4. How to prepare for technical interview rounds?<br/>
...
<ul>
	...
	<li>Writing code should be the last thing you should be doing after you have discussed your solution with the interviewer including. Try to write a clean, working code in the first attempt with all the edge cases covered. Dry run your code using the test cases you were given(or you asked for) during the interview before submitting your code. 
	</li>
</ul><br/>
...
<ul>
	...
	<li>The difficulty level of questions will depend upon the role you are being hired for. SDE >> Analyst >> Consultant</li>
...
<ul>
	...
	<li><b>DBMS:</b>You must be familiar with database basic concepts like keys, normalization, ACID properties, indexing, transaction management. You can refer here for preparing. </li>
...
5. I’m good in tech interviews but HR interviews freak me out. What to do?<br/>
...
<ul>
	...
	<li>The hiring process will depend on the job profile you are being hired for. So try to clarify all your doubts and queries. An SDE role at Amazon may have separate responsibilities from an analyst at GoldmanSachs.</li>
